...
from utils_ner import convert_examples_to_features, get_labels, read_examples_from_file,read_examples_from_json
...
def load_and_cache_examples(args, tokenizer, labels, pad_token_label_id, mode):
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache:
        ...
        examples = read_examples_from_json(args.data_dir,mode)
